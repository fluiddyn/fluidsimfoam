...
params.fv_options.momentum_source.active = "yes"
params.fv_options.momentum_source.mean_velocity_force_coeffs.ubar = "(0.1 0 0)"
params.fv_options.atm_coriolis_u_source1.active = "yes"
