...
def create_code_tgv():
    ...
    bmd = BlockMeshDict()
    bmd.set_metric("m", scale=6.28318530718)
    ...
    # face element of block can be generated by Block.face method
    bmd.add_boundary(
        "cyclic", "upperBoundary", [b0.face("n")], neighbour_patch="lowerBoundary"
    )
    bmd.add_boundary(
        "cyclic", "lowerBoundary", [b0.face("s")], neighbour_patch="upperBoundary"
    )
    bmd.add_boundary(
        "cyclic", "leftBoundary", [b0.face("w")], neighbour_patch="rightBoundary"
    )
    bmd.add_boundary(
        "cyclic", "rightBoundary", [b0.face("e")], neighbour_patch="leftBoundary"
    )
    bmd.add_boundary(
        "cyclic", "frontBoundary", [b0.face("t")], neighbour_patch="backBoundary"
    )
    bmd.add_boundary(
        "cyclic", "backBoundary", [b0.face("b")], neighbour_patch="frontBoundary"
    )
